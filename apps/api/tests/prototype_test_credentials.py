...
KNOWN_PASSWORD = PROTOTYPE_BOOTSTRAP_PASSWORD  # NOSONAR python:S2068 — from env in pytest
BOOTSTRAP_HASH = prototype_bootstrap_password_hash()
LARRY_PASSWORD = LARRY_PROTOTYPE_PASSWORD  # NOSONAR python:S2068 — documented prototype only
