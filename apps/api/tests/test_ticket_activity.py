...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("ticket.status_changed", {"previous_status": "new", "status": "in_progress"}, "I gang", "external"),
        ...
        ("ticket.attachment.uploaded", {"filename": "doc.pdf", "scan_status": "clean"}, "doc.pdf", "external"),
        ("sla.escalated", {"level": 2}, "SLA-eskalering", "system"),
        ("ticket.slack_pushed", {"channel_name": "it-support"}, "Slack", "internal"),
        ("email.received", {"from": "borger@example.dk", "subject": "Hjælp"}, "E-mail modtaget", "external"),
